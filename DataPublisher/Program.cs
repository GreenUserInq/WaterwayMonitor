...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        {
            var data = JsonService.LoadFromJsonFile<DataPublisher.WaterMonitoring.Models.MonitoringParameters>("C:\\Users\\Dmitry\\source\\repos\\WaterwayMonitor\\MonitoringData.json");
